  ...
  return (
    <PageWrapper>
      ...
      <MediumSpace>
        ...
        <Button icon={faCalendarCheck}>With Icon</Button>
        <Button inverted>Button Inverted</Button>
        <Button inverted icon={faCalendarCheck}>Icon Inverted</Button>
      </MediumSpace>
      <Heading>
        <h2>Rounded</h2>
      </Heading>
      <MediumSpace>
        ...
        <Button round icon={faCalendarCheck}> With Icon</Button>
        <Button round inverted>Button Inverted</Button>
        <Button round inverted icon={faCalendarCheck}>Icon Inverted</Button>
      </MediumSpace>
      <Heading>
        <h2>Link Buttons</h2>
      </Heading>
